				...
				<div class="portlet-body">
					<div class="clearfix">
						<div class="btn-group">
							...
							<a href="<?php echo U('User/adminEdit');?>" style="color:white;text-decoration:none;">新增</a>&nbsp;<i class="icon-plus"></i>
							</button>
						</div>
						<div class="btn-group">
							<button id="sample_editable_1_new" class="btn red ajax-post btn-warning" url="<?php echo U('User/adminStatus',array('type'=>'forbid','moble'=>'Admin'));?>" target-form="ids">
							禁用&nbsp;<i class="icon-lock"></i>
							</button>
						</div>
						<div class="btn-group">
							<button id="sample_editable_1_new" class="btn green ajax-post btn-info" url="<?php echo U('User/adminStatus',array('type'=>'resume','moble'=>'Admin'));?>" target-form="ids">
							启用&nbsp;<i class="icon-unlock"></i>
							</button>
						</div>
						<div class="btn-group">
							<button id="sample_editable_1_new" class="btn red ajax-post confirm btn-danger" url="<?php echo U('User/adminStatus',array('type'=>'del','moble'=>'Admin'));?>" target-form="ids">
						...
						<form name="formSearch" id="formSearch" method="get" class="btn-group pull-right">
							<div class="btn-group pull-right" id="sample_1_filter">
								...
								<select style=" width: 160px; height:34px; float: left; margin-right: 10px;" name="field" class="form-control">
									...
									<?php if(($_GET['field']) == "nickname"): ?>selected<?php endif; ?>
									>真实姓名</option>
									<option value="mobile"
					...
					<table class="table table-striped table-bordered table-hover" id="sample_1">
						...
						<tbody>
							<?php if(!empty($list)): if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr class="odd gradeX">
									...
									<td class="center hidden-480"><?php echo ($vo["mobile"]); ?></td>
									...
									<td ><a href="<?php echo U('User/adminEdit?id='.$vo['id']);?>" class="btn mini purple"><i class="icon-edit"></i>&nbsp;编辑</a></td>
