				...
				<div class="portlet-body">
					<div class="clearfix">
						<div class="btn-group">
							...
							<a href="<?php echo U('Article/adverEdit');?>" style="color:white;text-decoration:none;">新增</a>&nbsp;<i class="icon-plus"></i>
							</button>
						</div>
						<div class="btn-group">
							<button id="sample_editable_1_new" class="btn red ajax-post btn-warning" url="<?php echo U('Article/adverStatus',array('type'=>'forbid','moble'=>'Adver'));?>" target-form="ids">
							禁用&nbsp;<i class="icon-lock"></i>
							</button>
						</div>
						<div class="btn-group">
							<button id="sample_editable_1_new" class="btn green ajax-post btn-info" url="<?php echo U('Article/adverStatus',array('type'=>'resume','moble'=>'Adver'));?>" target-form="ids">
							启用&nbsp;<i class="icon-unlock"></i>
							</button>
						</div>
						<div class="btn-group">
							<button id="sample_editable_1_new" class="btn red ajax-post confirm btn-danger" url="<?php echo U('Article/adverStatus',array('type'=>'del','moble'=>'Adver'));?>" target-form="ids">
						...
						<form name="formSearch" id="formSearch" method="get" class="btn-group pull-right">
							<div class="btn-group pull-right" id="sample_1_filter">
								...
								<select style=" width: 160px; height:34px; float: left; margin-right: 10px;" name="field" class="form-control">
									...
									>图片名称</option>
									<option value="url"
									<?php if(($_GET['field']) == "url"): ?>selected<?php endif; ?>
									>图片链接</option>
									<option value="sort"
									<?php if(($_GET['field']) == "sort"): ?>selected<?php endif; ?>
									>图片排序</option>
									<option value="id"
								...
								<a href="<?php echo U('Article/adver');?>">
					...
					<table class="table table-striped table-bordered table-hover" id="sample_1">
						...
						<tbody>
							<?php if(!empty($list)): if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr class="odd gradeX">
									...
									<td class="hidden-480"><a href="#" style="text-decoration:none;"><?php echo ($vo["url"]); ?></a></td>
									<td class="center hidden-480"><img src="/Upload/adver/<?php echo ($vo["img"]); ?>" style="height:20px;"/></td>
									<td class="center hidden-480"><?php echo (addtime($vo["addtime"])); ?></td>
									<td class="center hidden-480"><?php echo (addtime($vo["endtime"])); ?></td>
									<td class="center hidden-480"><?php echo ($vo["sort"]); ?></td>
									...
									<td ><a href="<?php echo U('Article/adverEdit?id='.$vo['id']);?>" class="btn mini purple"><i class="icon-edit"></i>&nbsp;编辑</a></td>
