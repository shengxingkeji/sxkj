				...
				<div class="portlet-body">
					<div class="clearfix">
						<div class="btn-group">
							...
							<a href="<?php echo U('Article/linksEdit');?>" style="color:white;text-decoration:none;">新增</a>&nbsp;<i class="icon-plus"></i>
							</button>
						</div>
						<div class="btn-group">
							<button id="sample_editable_1_new" class="btn red ajax-post btn-warning" url="<?php echo U('Article/linksStatus',array('type'=>'forbid','moble'=>'Link'));?>" target-form="ids">
							禁用&nbsp;<i class="icon-lock"></i>
							</button>
						</div>
						<div class="btn-group">
							<button id="sample_editable_1_new" class="btn green ajax-post btn-info" url="<?php echo U('Article/linksStatus',array('type'=>'resume','moble'=>'Link'));?>" target-form="ids">
							启用&nbsp;<i class="icon-unlock"></i>
							</button>
						</div>
						<div class="btn-group">
							<button id="sample_editable_1_new" class="btn red ajax-post confirm btn-danger" url="<?php echo U('Article/linksStatus',array('type'=>'del','moble'=>'Link'));?>" target-form="ids">
					...
					<table class="table table-striped table-bordered table-hover" id="sample_1">
						...
						<tbody>
							<?php if(!empty($list)): if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr class="odd gradeX">
									...
									<td class="center hidden-480"><a href="#" style="text-decoration:none;"><?php echo ($vo["url"]); ?></a></td>
